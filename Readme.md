...
- 🎓 Pursuing **BCA** — leveling up every day
- 🔭 Currently building **full-stack Java + React applications**
...
| 🗂️ Project | 🔧 Tech Stack | 📝 Description | 🔗 Link |
|:---|:---|:---|:---:|
| 📚 **Book Management App** | React, Tailwind CSS, REST API | Full-featured CRUD app to manage books with search & filter | [View →](https://github.com/ahin-2007) |
| 🔐 **Authentication System** | Java, Spring Boot, Spring Security, JWT | Secure login/signup with JWT token-based authentication | [View →](https://github.com/ahin-2007) |
| 🛒 **E-Commerce Website** | React, Java, Spring Boot, MySQL | Full-stack e-commerce platform with cart & payment flow | [View →](https://github.com/ahin-2007) |
| 🌐 **Portfolio Website** | HTML5, CSS3, JavaScript | Personal portfolio with smooth animations & responsive design | [Live →](https://ahin-2007.github.io/portfolio/) |
| ☕ **Spring Boot REST API** | Java, Spring Boot, MySQL, JPA | RESTful backend with CRUD operations and clean architecture | [View →](https://github.com/ahin-2007) |
